...
from .views import SchemeViewSet, SchemeCategoryViewSet, SchemeTemplateViewSet, SchemeEntryViewSet, SchemeEntryCommentViewSet, UnionCouncilViewSet
...
router.register('union-councils', UnionCouncilViewSet, basename='union-councils')
