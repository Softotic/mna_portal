...
const theme = createTheme({
  ...
  typography: {
    ...
    h1: { fontFamily: '"Newsreader", "Georgia", serif', fontWeight: 700, lineHeight: 1.02, letterSpacing: 0 },
    h2: { fontFamily: '"Newsreader", "Georgia", serif', fontWeight: 700, lineHeight: 1.04, letterSpacing: 0 },
    h3: { fontFamily: '"Newsreader", "Georgia", serif', fontWeight: 700, lineHeight: 1.08, letterSpacing: 0 },
    h4: { fontFamily: '"Newsreader", "Georgia", serif', fontWeight: 700, lineHeight: 1.12, letterSpacing: 0 },
